...
public final class InsertJobTableLineageExtractorTest {
            ...
            CompositeLineage.newBuilder()
                ...
                .setJobInformation(
                    JobInformation.newBuilder()
                        ...
                        .setJobId(
                            "projects/myproject/jobs/bquxjob_264a99a3_171ef37d030")
                        .build()
                )
                .setTableLineage(
  ...
  public void extract_noReferencedTables_lineageWithEmptyParents() {
    Truth.assertThat(
        new InsertJobTableLineageExtractor(testClock,
  ...
  public void extract_loadJob_completedLineage() {
    Truth.assertThat(
        new InsertJobTableLineageExtractor(testClock,
            TestResourceLoader.load("bq_file_load_job.json"))
            .extract())
        .isEqualTo(
            CompositeLineage.newBuilder()
                .setReconcileTime(testClock.instant().toEpochMilli())
                .setJobInformation(
                    JobInformation.newBuilder()
                        ...
                        .setJobId(
                            "projects/bq-lineage-demo/jobs/bquxjob_718728d9_171f059e94d")
                        .build()
                )
                .setTableLineage(
                    TableLineage.newBuilder()
  ...
  public void extract_copyJobTempTable_empty() {
    Truth.assertThat(
        new InsertJobTableLineageExtractor(testClock,
            TestResourceLoader.load("bq_query_copy_temp_table.json"))
            .extract())
